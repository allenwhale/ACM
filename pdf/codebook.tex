...
\usepackage{xeCJK}
\usepackage{CJKutf8} 
\usepackage{amsmath, courier, listings, fancyhdr, graphicx, pdfpages}
%\topmargin=0pt
\headsep=5pt
\textheight=740pt
\footskip=0pt
...
\lstset{                                            
    ...
    \input{./../codebook/math/number/catalan_number.tex}
    \subsection{Long PI}
    ...
    \section{Match}
    \subsection{Match}
    \input{./../codebook/graph/match.tex}
    \subsection{BiMatch}
    ...
    \input{./../codebook/graph/kirchhoff.tex}
    ...
    \lstinputlisting{./../codebook/geometry/geometric_median.cpp}
    %\newpage
    ...
    \input{./../codebook/misc/nim_misere.tex}
	\newpage

    %\section{Treap}
    %\lstinputlisting{./../codebook/ds/treap.cpp}
	\newpage
    %\includepdf{./../codebook/math/number/calculus.pdf}
    \centering
